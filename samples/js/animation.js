...
function advance2(){
	...
	var node2 = new Fucksvg.CircleNode();
	node2.setLocation(600,100);
	box.addElement(node2);

	var link = new Fucksvg.Link(node, node2);
	box.addElement(link);
...
function advance3(){
	...
	for(var i=0; i<count; i++){
		...
		box.addElement(node);
		if(i>0){
			var link = new Fucksvg.Link(node, nodes[i-1]);
			box.addElement(link);
		}
		nodes.push(node);
	}
...
function advance4(){
	...
	var cNode = new Fucksvg.CircleNode();
	cNode.setLocation(600,100);
	box.addElement(cNode);

	box.addElement(new Fucksvg.Link(node, cNode));
	box.addElement(new Fucksvg.Link(node2, cNode));
	box.addElement(new Fucksvg.Link(node3, cNode));
...
function sunstart(){
	...
	var sunNode = new Fucksvg.HeartNode('');
	sunNode.style.fillStyle = 'rgba(255,0,0,0.5)';
	sunNode.setLocation(300 , 200);
	sunNode.color = "rgb(0, 0, 255)";
	
	var moonNode = new Fucksvg.CircleNode('');
	moonNode.setLocation(360 , 360);
	moonNode.color = "rgb(234, 226, 74)";					

	var link = new Fucksvg.Link(node , moonNode);
	box.addElement(link);
	
	var link2 = new Fucksvg.Link(sunNode , moonNode);
